...
class connection:
    ...
    def __init__(self):
        ...
        self.port = int(os.environ.get("DB_PORT", "8432"))
        self.user = os.environ.get("DB_USER", "a11yPython")
        self.password = os.environ.get("DB_PASSWORD", "SnakeInTheWeb")
        self.db_name = os.environ.get("DB_NAME", "a11y")
        self.conn = None
        self.cur = None
